    ...
    NavHost(
        ...
        composable(OnboardingRoutes.LevelOneReveal) {
            HomeScreen(
                ...
                onOpenScore = {
                    navController.navigate(OnboardingRoutes.Score) { launchSingleTop = true }
                },
                onOpenSettings = {
        ...
        composable(OnboardingRoutes.Score) {
            ProgressDashboardScreen(
                onOpenHome = { navController.navigateBackToMain() },
                onOpenSettings = {
                    navController.navigate(OnboardingRoutes.Settings) { launchSingleTop = true }
                },
            )
        }
