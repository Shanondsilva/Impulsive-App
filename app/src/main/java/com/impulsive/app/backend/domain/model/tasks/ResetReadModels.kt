...
val StarterResetReadArticles = listOf(
    ResetReadArticle(
        ...
        blocks = listOf(
            ...
            ArticleBlock.Paragraph("A helpful plan starts with one move that is easy to begin. Stand up. Fill a glass. Open a timer. Put the phone down for one minute. The first action works because it interrupts the feeling that you need to decide everything at once."),
            ...
            ArticleBlock.Paragraph("This kind of plan works because it removes delay. You do not need to invent the response while the urge is loud. You only need to carry out the next small step you prepared earlier."),
    ...
    ResetReadArticle(
        ...
        blocks = listOf(
            ...
            ArticleBlock.Paragraph("If you miss the first minute, the moment is still not lost. You have the next minute. Recovery is often a series of returns, not a single perfect stop. That is why the app asks for one helpful action rather than a flawless one."),
    ...
    ResetReadArticle(
        ...
        blocks = listOf(
            ...
            ArticleBlock.Paragraph("The first step should answer the question, 'What do I do now?' without making you think. If the answer is already visible, attention can move faster. That is useful because the urge loop loses strength when it does not get extra time."),
